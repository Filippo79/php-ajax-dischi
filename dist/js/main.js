...
$(document).ready(function () {
  ...
  $.ajax({
    url: 'server.php',
    method: 'GET',
    success: function success(datiAlbums) {
      //console.log(datiAlbums);
      var albums = datiAlbums;

      for (var i = 0; i < albums.length; i++) {
        var albumSingolo = albums[i]; //console.log(albumSingolo);
...
__webpack_require__(/*! /Applications/MAMP/htdocs/Boolean/Esercizi/35/php-ajax-dischi/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/Boolean/Esercizi/35/php-ajax-dischi/src/app.scss */"./src/app.scss");
